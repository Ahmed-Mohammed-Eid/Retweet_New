"use client";
import classes from "./HouseKitchens.module.scss";
...
// JSON DATA
import PhoneNumbersJson from "../../../../../../../Json_Data/HouseAndGarden/HouseKitchens.json";

export default function HouseKitchens({
	locale,
	categoryName,
	subCategoryName,
	submit = () => {},
