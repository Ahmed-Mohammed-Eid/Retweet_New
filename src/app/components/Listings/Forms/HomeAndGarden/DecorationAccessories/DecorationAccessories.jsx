"use client";
import classes from "./DecorationAccessories.module.scss";
...
// JSON DATA
import PhoneNumbersJson from "../../../../../../../Json_Data/HouseAndGarden/DecorationAccessories.json";

export default function DecorationAccessories({
	locale,
	categoryName,
	subCategoryName,
	submit = () => {},
