"use client";
import classes from "./ChargersAndCables.module.scss";
...
// JSON DATA
import PhoneNumbersJson from "../../../../../../../Json_Data/mobilesAndTablets/chargersAndCables.json";

export default function ChargersAndCables({
	locale,
	categoryName,
	subCategoryName,
	submit = () => {},
