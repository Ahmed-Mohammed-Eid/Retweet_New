"use client";
import classes from "./CoversAndProtectors.module.scss";
...
// JSON DATA
import PhoneNumbersJson from "../../../../../../../Json_Data/mobilesAndTablets/coversAndProtectors.json";

export default function CoversAndProtectors({
	locale,
	categoryName,
	subCategoryName,
	submit = () => {},
