"use client";
import classes from "./DishWashers.module.scss";
...
// JSON DATA
import DishWashersJson from "../../../../../../../Json_Data/Electronics/DishWashers.json";
...
export default function DishWashers({
	...
	const [listingDetails, setListingDetails] = useState({
		[String(DishWashersJson[0].labelEn).toLocaleLowerCase()]: {
			labelAr: DishWashersJson[0].labelAr,
			labelEn: DishWashersJson[0].labelEn,
			value: "",
		},
		[String(DishWashersJson[1].labelEn).toLocaleLowerCase()]: {
			labelAr: DishWashersJson[1].labelAr,
			labelEn: DishWashersJson[1].labelEn,
			value: "",
		},
		[String(DishWashersJson[2].labelEn).toLocaleLowerCase()]: {
			labelAr: DishWashersJson[2].labelAr,
			labelEn: DishWashersJson[2].labelEn,
			value: "",
		},
		[String(DishWashersJson[3].labelEn).toLocaleLowerCase()]: {
			labelAr: DishWashersJson[3].labelAr,
			labelEn: DishWashersJson[3].labelEn,
			value: "",
		},
		[String(DishWashersJson[4].labelEn).toLocaleLowerCase()]: {
			labelAr: DishWashersJson[4].labelAr,
			labelEn: DishWashersJson[4].labelEn,
			value: "",
		},
	});
	...
	const modelsOptions = DishWashersJson[0].Values.map((value) => {
		return {
	...
	const modelsOptions2 = DishWashersJson[1].Values.map((value) => {
		return {
			label: locale === "en" ? value.labelEn : value.labelAr,
			value: value.labelEn,
		};
		...
		<div className={`${classes.SpareParts} rounded p-4`}>
			...
			>
				...
				<div className={`${classes.Type} rounded bg-white mt-4`}>
					<h3>
						{locale === "en"
							? DishWashersJson[0].labelEn
							: DishWashersJson[0].labelAr}
					</h3>
				...
				<div className={`${classes.Type} rounded bg-white mt-4`}>
					<h3>
						{locale === "en"
							? DishWashersJson[1].labelEn
							: DishWashersJson[1].labelAr}
					</h3>
					<div className={"flex justify-start gap-2 flex-wrap"}>
						<DropDown
							value={
				...
				<div className={`${classes.Type} rounded bg-white mt-4`}>
					<h3>
						{locale === "en"
							? DishWashersJson[2].labelEn
							: DishWashersJson[2].labelAr}
					</h3>
					<div className={"flex justify-start gap-2 flex-wrap"}>
						<input
							type="text"
				...
				<div className={`${classes.Type} rounded bg-white mt-4`}>
					<h3>
						{locale === "en"
							? DishWashersJson[3].labelEn
							: DishWashersJson[3].labelAr}
					</h3>
					<div className={"flex justify-start gap-2 flex-wrap"}>
						{DishWashersJson[3].Values.map((value, index) => {
							return (
								<RadioComponent
									key={index}
									locale={locale}
									...
									name={String(DishWashersJson[3].labelEn)}
									onChange={(event) => {
										setListingDetails({
											...listingDetails,
											[String(
				...
				<div className={`${classes.Type} rounded bg-white mt-4`}>
					<h3>
						{locale === "en"
							? DishWashersJson[4].labelEn
							: DishWashersJson[4].labelAr}
					</h3>
					<div className={"flex justify-start gap-2 flex-wrap"}>
						{DishWashersJson[4].Values.map((value, index) => {
							return (
								<RadioComponent
									key={index}
									locale={locale}
									...
									textAr={value.labelAr}
									textEn={value.labelEn}
									name={String(DishWashersJson[4].labelEn)}
									onChange={(event) => {
										setListingDetails({
											...listingDetails,
											[String(
