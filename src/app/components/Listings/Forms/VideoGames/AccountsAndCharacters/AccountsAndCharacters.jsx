"use client";
import classes from "./AccountsAndCharacters.module.scss";
...
// JSON DATA
import PhoneNumbersJson from "../../../../../../../Json_Data/VideoGames/accountsAndCharacters.json";

export default function AccountsAndCharacters({
	locale,
	categoryName,
	subCategoryName,
	submit = () => {},
