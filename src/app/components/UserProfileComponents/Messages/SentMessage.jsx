...
export default function SentMessage({message, time}) {
    ...
    return (
        <section className={classes.sent_message}>
            <div className={classes.overflow__arrow}></div>
            <div className={classes.sent_message_top}>
                <span className={classes.sent_message_time}>
                    {timeForPreview}
                </span>
            </div>
            <div className={classes.sent_message_bottom}>
                <p className={classes.sent_message_text}>
                    {message}
                </p>
            </div>
        </section>
